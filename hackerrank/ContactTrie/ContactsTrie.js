...
function contacts(queries) {
  ...
  for (let [command, string] of queries) {
      
    console.log(`Queries = ${queries}  length= ${queries.length}`)
    console.log(`    command=${command}   string=${string}`)
...
// const param = 
const r = contacts( [['add', 'hack'], ['add', 'hackarank'], ['find', 'hac']])
